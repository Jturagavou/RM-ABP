...
struct CreateTaskView: View {
    ...
    private var eventLinkingSection: some View {
        Group {
    ...
    private func saveTask() {
        ...
        if let existingTask = taskToEdit {
            ...
            t.updatedAt = Date()
            t.completedAt = existingTask.completedAt
            task = t
        } else {
            var t = AppTask(
                title: title,
...
class NotificationManager {
    ...
    func scheduleTaskReminder(for task: AppTask, at date: Date) {
